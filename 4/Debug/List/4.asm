...
; 0000 0024 int c=0 ;
; 0000 0025 int d=0 ;
; 0000 0026 unsigned char seg[10]={0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F};
...
; 0000 003C DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
; 0000 0042 DDRE=(1<<DDE7) | (1<<DDE6) | (1<<DDE5) | (1<<DDE4) | (1<<DDE3) | (1<<DDE2) | (1<<DDE1) | (1<<DDE0);
	LDI  R30,LOW(255)
	OUT  0x2,R30
...
; 0000 00AD // USART0 disabled
; 0000 00AE UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	OUT  0xA,R30
; 0000 00AF 
; 0000 00B0 // USART1 initialization
; 0000 00B1 // USART1 disabled
; 0000 00B2 UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  154,R30
; 0000 00B3 
...
; 0000 00CA  {
; 0000 00CB 
; 0000 00CC  PORTE=seg[a];
	RCALL SUBOPT_0x1
	OUT  0x3,R30
; 0000 00CD  PORTD=seg[a];
	RCALL SUBOPT_0x1
	OUT  0x12,R30
; 0000 00CE  PORTC=seg[a];
	RCALL SUBOPT_0x1
	OUT  0x15,R30
; 0000 00CF  PORTB=seg[a];
	RCALL SUBOPT_0x1
	OUT  0x18,R30
; 0000 00D0 
; 0000 00D1   if (key1 == 0)
...
; 0000 00EA      }
; 0000 00EB 
; 0000 00EC            PORTE=seg[a];
_0xF:
	RCALL SUBOPT_0x1
	OUT  0x3,R30
; 0000 00ED            PORTD=seg[b];
	MOVW R26,R28
	ADD  R26,R18
	ADC  R27,R19
	LD   R30,X
	OUT  0x12,R30
; 0000 00EE            PORTC=seg[c];
	MOVW R26,R28
	ADD  R26,R20
	ADC  R27,R21
	LD   R30,X
	OUT  0x15,R30
; 0000 00EF            PORTB=seg[d];
	LDD  R30,Y+10
	LDD  R31,Y+10+1
	MOVW R26,R28
	ADD  R26,R30
