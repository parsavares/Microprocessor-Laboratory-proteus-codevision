...
; 0000 0020 int a=0 ;
; 0000 0021 unsigned char seg[10]={0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F};
...
; 0000 008F      a = a+1;
	__ADDWRN 16,17,1
; 0000 0090      if (a>9) {  a=0; }
	__CPWRN 16,17,10
	BRLT _0x8
	__GETWRN 16,17,0
; 0000 0091      PORTC=seg[a];
_0x8:
	RCALL SUBOPT_0x0
; 0000 0092      delay_ms(666);
	LDI  R26,LOW(666)
	LDI  R27,HIGH(666)
	CALL _delay_ms
; 0000 0093    }
...
; 0000 0097      a = a-1;
	__SUBWRN 16,17,1
; 0000 0098      if (a<0) {  a=0; }
	TST  R17
	BRPL _0xA
	__GETWRN 16,17,0
; 0000 0099      PORTC=seg[a];
_0xA:
	RCALL SUBOPT_0x0
; 0000 009A      delay_ms(666);
	LDI  R26,LOW(666)
	LDI  R27,HIGH(666)
	CALL _delay_ms
; 0000 009B    }
