...
; 0000 007E         if (PINC.0==1) a=1;
	SBIS 0x13,0
	RJMP _0x6
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	MOVW R4,R30
; 0000 007F         if (PINC.1==1) a=2;
_0x6:
	SBIS 0x13,1
	RJMP _0x7
	LDI  R30,LOW(2)
...
; 0000 0084 PORTB.1=1;
	SBI  0x18,1
; 0000 0085 delay_ms(75);
	RCALL SUBOPT_0x0
; 0000 0086 PORTB=0b01010101;
	LDI  R30,LOW(85)
	RCALL SUBOPT_0x1
; 0000 0087 delay_ms(75);
; 0000 0088 }
; 0000 0089 if(a==2)
_0x9:
	LDI  R30,LOW(2)
	...
	BRNE _0xE
; 0000 008A {
; 0000 008B PORTB=0b11110000;
	LDI  R30,LOW(240)
	RCALL SUBOPT_0x1
; 0000 008C delay_ms(75);
; 0000 008D PORTB=0b00001111;
	LDI  R30,LOW(15)
	RCALL SUBOPT_0x1
; 0000 008E delay_ms(75);
; 0000 008F }
; 0000 0090 if(a==3)
_0xE:
	LDI  R30,LOW(3)
	...
	BRNE _0xF
; 0000 0091 {
; 0000 0092 PORTB=0b10101010;
	LDI  R30,LOW(170)
	RCALL SUBOPT_0x1
; 0000 0093 delay_ms(75);
; 0000 0094 PORTB=0b01010101;
	LDI  R30,LOW(85)
	RCALL SUBOPT_0x1
; 0000 0095 delay_ms(75);
; 0000 0096 }
; 0000 0097 }
_0xF:
	RJMP _0x3
