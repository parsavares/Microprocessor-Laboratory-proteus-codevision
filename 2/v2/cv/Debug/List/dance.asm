...
; 0000 0023 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 007E         if (PINC.0==0 && PINC.1==0 && PINC.2==0) {
	SBIC 0x13,0
	RJMP _0x7
	SBIC 0x13,1
	RJMP _0x7
...
; 0000 007F         a=1;
	...
	MOVW R4,R30
; 0000 0080         }
; 0000 0081         if (PINC.0==1 && PINC.1==0 && PINC.2==0) {
_0x6:
	SBIS 0x13,0
	RJMP _0xA
	SBIC 0x13,1
...
; 0000 0082         a=2;
	...
	MOVW R4,R30
; 0000 0083         }
; 0000 0084         if (PINC.0==0 && PINC.1==1 && PINC.2==0) {
_0x9:
	SBIC 0x13,0
	RJMP _0xD
	SBIS 0x13,1
...
; 0000 0085         a=3;
	...
	MOVW R4,R30
; 0000 0086         }
; 0000 0087         if (PINC.0==1 && PINC.1==1 && PINC.2==0) {
_0xC:
	SBIS 0x13,0
	RJMP _0x10
	SBIS 0x13,1
...
; 0000 0088         a=4;
	...
	MOVW R4,R30
; 0000 0089         }
; 0000 008A         if (PINC.0==0 && PINC.1==0 && PINC.2==1) {
_0xF:
	SBIC 0x13,0
	RJMP _0x13
	SBIC 0x13,1
...
; 0000 008B         a=5;
	...
	MOVW R4,R30
; 0000 008C         }
; 0000 008D         if (PINC.0==1 && PINC.1==0 && PINC.2==1) {
_0x12:
	SBIS 0x13,0
	RJMP _0x16
	SBIC 0x13,1
...
; 0000 008E         a=6;
	...
	MOVW R4,R30
; 0000 008F         }
; 0000 0090         if (PINC.0==0 && PINC.1==1 && PINC.2==1) {
_0x15:
	SBIC 0x13,0
	RJMP _0x19
	SBIS 0x13,1
...
; 0000 0091         a=7;
	...
	MOVW R4,R30
; 0000 0092         }
; 0000 0093         if (PINC.0==1 && PINC.1==1 && PINC.2==1) {
_0x18:
	SBIS 0x13,0
	RJMP _0x1C
	SBIS 0x13,1
...
; 0000 0099 PORTB.1=1;
	SBI  0x18,1
; 0000 009A delay_ms(75);
	RCALL SUBOPT_0x1
; 0000 009B PORTB=0b01010101;
	RCALL SUBOPT_0x2
; 0000 009C delay_ms(75);
; 0000 009D             }
; 0000 009E if(a==2)
_0x1E:
	LDI  R30,LOW(2)
	...
	BRNE _0x23
; 0000 009F             {
; 0000 00A0 PORTB=0b11110000;
	LDI  R30,LOW(240)
	RCALL SUBOPT_0x3
; 0000 00A1 delay_ms(75);
; 0000 00A2 PORTB=0b00001111;
	LDI  R30,LOW(15)
	RCALL SUBOPT_0x3
; 0000 00A3 delay_ms(75);
; 0000 00A4             }
; 0000 00A5 if(a==3)
_0x23:
	LDI  R30,LOW(3)
	...
	BRNE _0x24
; 0000 00A6 {
; 0000 00A7 PORTB=0b10101010;
	LDI  R30,LOW(170)
	RCALL SUBOPT_0x3
; 0000 00A8 delay_ms(75);
; 0000 00A9 PORTB=0b01010101;
	RCALL SUBOPT_0x2
; 0000 00AA delay_ms(75);
; 0000 00AB }
; 0000 00AC if(a==4)
_0x24:
	LDI  R30,LOW(4)
	...
	BRNE _0x25
; 0000 00AD {
; 0000 00AE PORTB=0b11110000;
	LDI  R30,LOW(240)
	RCALL SUBOPT_0x4
; 0000 00AF delay_ms(33);
; 0000 00B0 PORTB=0b00001111;
	LDI  R30,LOW(15)
	RCALL SUBOPT_0x4
; 0000 00B1 delay_ms(33);
; 0000 00B2 }
; 0000 00B3 if(a==5)
_0x25:
	LDI  R30,LOW(5)
	...
	BRNE _0x26
; 0000 00B4 {
; 0000 00B5 PORTB=0b10101010;
	LDI  R30,LOW(170)
	RCALL SUBOPT_0x4
; 0000 00B6 delay_ms(33);
; 0000 00B7 PORTB=0b01010101;
	LDI  R30,LOW(85)
	RCALL SUBOPT_0x4
; 0000 00B8 delay_ms(33);
; 0000 00B9 }
; 0000 00BA if(a==6)
_0x26:
	LDI  R30,LOW(6)
...
; 0000 00BD PORTB.1=1;
	SBI  0x18,1
; 0000 00BE delay_ms(33);
	LDI  R26,LOW(33)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00BF PORTB=0b01010101;
	LDI  R30,LOW(85)
	RCALL SUBOPT_0x4
; 0000 00C0 delay_ms(33);
; 0000 00C1 }
; 0000 00C2 if(a==7)
_0x27:
	LDI  R30,LOW(7)
	...
	BRNE _0x2C
; 0000 00C3 {
; 0000 00C4 PORTB=0b10101010;
	LDI  R30,LOW(170)
	RCALL SUBOPT_0x3
; 0000 00C5 delay_ms(75);
; 0000 00C6 PORTB=0b11110000;
	LDI  R30,LOW(240)
	RCALL SUBOPT_0x3
; 0000 00C7 delay_ms(75);
; 0000 00C8  }
; 0000 00C9 if(a==8)
_0x2C:
	LDI  R30,LOW(8)
	...
	BRNE _0x2D
; 0000 00CA  {
; 0000 00CB PORTB=0b01010101;
	RCALL SUBOPT_0x2
; 0000 00CC delay_ms(75);
; 0000 00CD PORTB=0b00001111;
	LDI  R30,LOW(15)
	RCALL SUBOPT_0x3
; 0000 00CE delay_ms(75);
; 0000 00CF  }
; 0000 00D0 }
_0x2D:
	RJMP _0x3
